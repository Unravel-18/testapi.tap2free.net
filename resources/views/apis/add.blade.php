...
@section('title')
<title>Добавление нового Api</title>
@endsection
...
<div class="text_box">
  ...
  @endif
  <form class="form" id="event_form" action="{{ route('apis.save') }}" method="post" autocomplete="off" enctype="multipart/form-data">
    {{ csrf_field() }}
    <br />
    <button type="submit" class="btn btn-primary btn-block-xs submit">Добавить Api</button>
    <br />
    <br />
    ...
    <div class="form-group">
      <label for="name" class="control-label">Package <sup>*</sup></label>
