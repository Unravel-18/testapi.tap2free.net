...
*/
 ...
 $ACCESS_PWD='uI8eR1pK6q'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access

 #DEFAULT db connection settings
 # --- WARNING! --- if you set defaults - it's recommended to set $ACCESS_PWD to protect your db!
 $DBDEF=array(
 'user'=>"testapi",#required
 'pwd'=>"uI8eR1pK6q", #required
 'db'=>"testapi",  #optional, default DB
